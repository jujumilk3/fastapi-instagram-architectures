...
from cqrs_es.shared.database import Base, get_db

TEST_DATABASE_URL = "sqlite+aiosqlite:///./test_cqrs_es.db"
...
async def setup_db():
    ...
    from cqrs_es.read.projections.models import (  # noqa: F401
        UserProjection,
        PostProjection,
        CommentProjection,
        LikeProjection,
